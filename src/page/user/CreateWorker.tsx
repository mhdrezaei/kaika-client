...
const CreateWorker = () => {
  ...
  return (
    <>
    <div className="w-full bg-kaika-black p-0 sm:p-12 md:p-24  rounded-md">
      <div className="container mx-auto   ">
      <Card className=" border border-1 border-gray-200 rounded-md bg-kaika-black shadow-sm  shadow-gray-300 hover:shadow-sm hover:shadow-kaika-yellow">
      <CardHeader
              variant="gradient"
              className="mb-14 grid h-28 place-items-center  bg-kaika-yellow shadow-xl"
            >
    ...
    <CardFooter className="pt-0 pb-8 text-center">
              <Button
                ...
                fullWidth
              >
                {isLoading ? <BeatLoader color="#fff" size={16} /> : "Submit"}
              </Button>
              </CardFooter>
  </form>
  </Card>
  ...
  <div className="absolute z-40 top-5 right-5 flex flex-col items-end justify-center w-96">
  <Alert
    show={isSuccess}
    color="green"
