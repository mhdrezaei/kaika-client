  ...
  return (
    ...
    >
      {disabled ? (
        ...
        <>
          <span className="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full bg-kaika-yellow/80 group-hover:translate-x-0 ease">
            {icon}&nbsp;{slide_text}
          </span>
